...
===============================================================================
Purpose:
    This procedure performs the ETL process to transition data from the Bronze 
    layer to the Silver layer. It includes:
    - Truncating existing Silver tables.
    - Data cleansing and transformation (Trimming, Case logic, Casting).
    - Error handling and performance tracking (Duration).
===============================================================================
*/
...
BEGIN
    ...
    BEGIN TRY
        ...
        INSERT INTO silver.erp_cust_az12(cst_cid, cst_bdate, cst_gen)
        SELECT 
        ...
        INSERT INTO silver.erp_loc_a101(loc_cid, loc_cntry)
        SELECT
            REPLACE(loc_cid,'-',''),
            CASE WHEN TRIM(loc_cntry) = 'DE' THEN 'Germany'
                 WHEN TRIM(loc_cntry) IN ('US', 'USA') THEN 'United States'
                 WHEN TRIM(loc_cntry) = '' OR loc_cid IS NULL THEN 'n/a'
                 ELSE TRIM(loc_cntry)
            END
        ...
        INSERT INTO silver.erp_px_cat_g1v2(px_id, px_cat, px_subcat, px_maintenance)
        SELECT px_id, px_cat, px_subcat, px_maintenance
